...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "p_distribusi"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => '9antau38LAtHZlL2', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/p_distribusi.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{E205BC04-25FF-44F6-B4D4-68928549C8E5}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_distribusi"]
	],
