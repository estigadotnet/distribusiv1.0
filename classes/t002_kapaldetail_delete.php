 ...
 * Page class
 */
class t002_kapaldetail_delete extends t002_kapaldetail
{
	...
	// Page object name
	public $PageObjName = "t002_kapaldetail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t002_kapaldetaillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t002_kapaldetaillist.php"); // Return to list
			}
		}
	}
