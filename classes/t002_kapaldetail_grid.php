 ...
 * Page class
 */
class t002_kapaldetail_grid extends t002_kapaldetail
{
	...
	// Page object name
	public $PageObjName = "t002_kapaldetail_grid";

	// Grid form hidden field names
	public $FormName = "ft002_kapaldetailgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "t001_kapal") {
			$this->kapal_id->Visible = FALSE;
			if ($GLOBALS["t001_kapal"]->EventCancelled)
