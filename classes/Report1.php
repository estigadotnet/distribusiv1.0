...
class Report1 extends ReportTable
{
	...
	public function __construct()
	{
		...
		// Update Table
		$this->UpdateTable = "`t101_result`";
		$this->ReportSourceTable = 't101_result'; // Report source table
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new ReportField('Report1', 'Report1', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->IsAutoIncrement = TRUE; // Autoincrement field
		$this->id->IsPrimaryKey = TRUE; // Primary key field
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->id->SourceTableVar = 't101_result';
		$this->fields['id'] = &$this->id;

		// Generasi
		$this->Generasi = new ReportField('Report1', 'Report1', 'x_Generasi', 'Generasi', '`Generasi`', '`Generasi`', 3, 9, -1, FALSE, '`Generasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->Generasi->SourceTableVar = 't101_result';
		$this->fields['Generasi'] = &$this->Generasi;

		// Kromosom
		$this->Kromosom = new ReportField('Report1', 'Report1', 'x_Kromosom', 'Kromosom', '`Kromosom`', '`Kromosom`', 201, 65535, -1, FALSE, '`Kromosom`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		$this->Kromosom->SourceTableVar = 't101_result';
		$this->fields['Kromosom'] = &$this->Kromosom;

		// TotalCost
		$this->TotalCost = new ReportField('Report1', 'Report1', 'x_TotalCost', 'TotalCost', '`TotalCost`', '`TotalCost`', 5, 22, -1, FALSE, '`TotalCost`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->TotalCost->SourceTableVar = 't101_result';
		$this->fields['TotalCost'] = &$this->TotalCost;

		// TotalCargo
		$this->TotalCargo = new ReportField('Report1', 'Report1', 'x_TotalCargo', 'TotalCargo', '`TotalCargo`', '`TotalCargo`', 4, 14, -1, FALSE, '`TotalCargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->TotalCargo->SourceTableVar = 't101_result';
		$this->fields['TotalCargo'] = &$this->TotalCargo;

		// Fitness
		$this->Fitness = new ReportField('Report1', 'Report1', 'x_Fitness', 'Fitness', '`Fitness`', '`Fitness`', 4, 14, -1, FALSE, '`Fitness`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`t101_result`";
	}
