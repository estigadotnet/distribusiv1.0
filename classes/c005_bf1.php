...
class c005_bf1
{
	...
	// Table name
	public $TableName = 'c005_bf1.php';

	// Page object name
	public $PageObjName = "c005_bf1";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'c005_bf1.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "c005_bf1", $url, "", "c005_bf1", TRUE);
		$this->Heading = $Language->TablePhrase("c005_bf1", "TblCaption"); 
	}
} // End class
?>