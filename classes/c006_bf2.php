...
class c006_bf2
{
	...
	// Table name
	public $TableName = 'c006_bf2.php';

	// Page object name
	public $PageObjName = "c006_bf2";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'c006_bf2.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "c006_bf2", $url, "", "c006_bf2", TRUE);
		$this->Heading = $Language->TablePhrase("c006_bf2", "TblCaption"); 
	}
} // End class
?>