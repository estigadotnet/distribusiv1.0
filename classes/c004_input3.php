...
class c004_input3
{
	...
	// Table name
	public $TableName = 'c004_input3.php';

	// Page object name
	public $PageObjName = "c004_input3";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'c004_input3.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "c004_input3", $url, "", "c004_input3", TRUE);
		$this->Heading = $Language->TablePhrase("c004_input3", "TblCaption"); 
	}
} // End class
?>