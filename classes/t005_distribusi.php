...
/**
 * Table class for t005_distribusi
 */
class t005_distribusi extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't005_distribusi';
		$this->TableName = 't005_distribusi';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t005_distribusi`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('t005_distribusi', 't005_distribusi', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// source_id
		$this->source_id = new DbField('t005_distribusi', 't005_distribusi', 'x_source_id', 'source_id', '`source_id`', '`source_id`', 3, 11, -1, FALSE, '`source_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->source_id->Nullable = FALSE; // NOT NULL field
		$this->source_id->Required = TRUE; // Required field
		$this->source_id->Sortable = TRUE; // Allow sort
		$this->source_id->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->source_id->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->source_id->Lookup = new Lookup('source_id', 't003_source', FALSE, 'id', ["Nama","","",""], [], [], [], [], [], [], '', '');
		$this->source_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['source_id'] = &$this->source_id;

		// destination_id
		$this->destination_id = new DbField('t005_distribusi', 't005_distribusi', 'x_destination_id', 'destination_id', '`destination_id`', '`destination_id`', 3, 11, -1, FALSE, '`destination_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->destination_id->Lookup = new Lookup('destination_id', 't004_destination', FALSE, 'id', ["Nama","","",""], [], [], [], [], [], [], '', '');
		$this->destination_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['destination_id'] = &$this->destination_id;

		// Jarak
		$this->Jarak = new DbField('t005_distribusi', 't005_distribusi', 'x_Jarak', 'Jarak', '`Jarak`', '`Jarak`', 4, 14, -1, FALSE, '`Jarak`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Jarak->Nullable = FALSE; // NOT NULL field
		$this->Jarak->Required = TRUE; // Required field
		...
		// RateO
		$this->RateO = new DbField('t005_distribusi', 't005_distribusi', 'x_RateO', 'RateO', '`RateO`', '`RateO`', 4, 14, -1, FALSE, '`RateO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RateO->Nullable = FALSE; // NOT NULL field
		$this->RateO->Required = TRUE; // Required field
		$this->RateO->Sortable = TRUE; // Allow sort
		$this->RateO->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RateO'] = &$this->RateO;

		// RateD
		$this->RateD = new DbField('t005_distribusi', 't005_distribusi', 'x_RateD', 'RateD', '`RateD`', '`RateD`', 4, 14, -1, FALSE, '`RateD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RateD->Nullable = FALSE; // NOT NULL field
		$this->RateD->Required = TRUE; // Required field
		$this->RateD->Sortable = TRUE; // Allow sort
		$this->RateD->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RateD'] = &$this->RateD;

		// Demand
		$this->Demand = new DbField('t005_distribusi', 't005_distribusi', 'x_Demand', 'Demand', '`Demand`', '`Demand`', 4, 14, -1, FALSE, '`Demand`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Demand->Nullable = FALSE; // NOT NULL field
		$this->Demand->Required = TRUE; // Required field
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`t005_distribusi`";
	}
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->RateO->DbValue = $row['RateO'];
		$this->RateD->DbValue = $row['RateD'];
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "t005_distribusilist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "t005_distribusiedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t005_distribusiadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("t005_distribusiview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t005_distribusiview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "t005_distribusiadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t005_distribusiadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t005_distribusiedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t005_distribusiadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t005_distribusidelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->RateO->setDbValue($rs->fields('RateO'));
		$this->RateD->setDbValue($rs->fields('RateD'));
	...
	public function renderEditRow()
	{
		...
		$this->RateO->EditValue = $this->RateO->CurrentValue;
		...
		$this->RateD->EditValue = $this->RateD->CurrentValue;
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->RateO);
					$doc->exportCaption($this->RateD);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->RateO);
						$doc->exportField($this->RateD);
