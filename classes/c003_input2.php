...
class c003_input2
{
	...
	// Table name
	public $TableName = 'c003_input2.php';

	// Page object name
	public $PageObjName = "c003_input2";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'c003_input2.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "c003_input2", $url, "", "c003_input2", TRUE);
		$this->Heading = $Language->TablePhrase("c003_input2", "TblCaption"); 
	}
} // End class
?>