...
class c002_input1
{
	...
	// Table name
	public $TableName = 'c002_input1.php';

	// Page object name
	public $PageObjName = "c002_input1";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'c002_input1.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "c002_input1", $url, "", "c002_input1", TRUE);
		$this->Heading = $Language->TablePhrase("c002_input1", "TblCaption"); 
	}
} // End class
?>