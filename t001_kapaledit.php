...
// Create page object
$t001_kapal_edit = new t001_kapal_edit();
...
$t001_kapal_edit->Page_Render();
?>
<?php include_once "header.php"; ?>
<script>
var ft001_kapaledit, currentPageID;
loadjs.ready("head", function() {

	// Form object
	currentPageID = ew.PAGE_ID = "edit";
	ft001_kapaledit = currentForm = new ew.Form("ft001_kapaledit", "edit");

	// Validate form
	ft001_kapaledit.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($t001_kapal_edit->Nama->Required) { ?>
	...
	// Form_CustomValidate
	ft001_kapaledit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
<?php $t001_kapal_edit->showPageHeader(); ?>
<?php
$t001_kapal_edit->showMessage();
?>
<form name="ft001_kapaledit" id="ft001_kapaledit" class="<?php echo $t001_kapal_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($Page->CheckToken) { ?>
<input type="hidden" name="<?php echo Config("TOKEN_NAME") ?>" value="<?php echo $Page->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t001_kapal">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$t001_kapal_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($t001_kapal_edit->Nama->Visible) { // Nama ?>
	<div id="r_Nama" class="form-group row">
		<label id="elh_t001_kapal_Nama" for="x_Nama" class="<?php echo $t001_kapal_edit->LeftColumnClass ?>"><?php echo $t001_kapal_edit->Nama->caption() ?><?php echo $t001_kapal_edit->Nama->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t001_kapal_edit->RightColumnClass ?>"><div <?php echo $t001_kapal_edit->Nama->cellAttributes() ?>>
...
<div class="custom-control custom-checkbox d-inline-block">
	<input type="checkbox" class="custom-control-input" data-table="t001_kapal" data-field="x_Diproses" name="x_Diproses[]" id="x_Diproses[]_823817" value="1"<?php echo $selwrk ?><?php echo $t001_kapal_edit->Diproses->editAttributes() ?>>
	<label class="custom-control-label" for="x_Diproses[]_823817"></label>
</div>
</span>
...
<?php } ?>
	...
	<input type="hidden" data-table="t001_kapal" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($t001_kapal_edit->id->CurrentValue) ?>">
<?php
	if (in_array("t002_kapaldetail", explode(",", $t001_kapal->getCurrentDetailTable())) && $t002_kapaldetail->DetailEdit) {
?>
...
<?php } ?>
<?php if (!$t001_kapal_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $t001_kapal_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $t001_kapal_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$t001_kapal_edit->showPageFooter();
if (Config("DEBUG"))
